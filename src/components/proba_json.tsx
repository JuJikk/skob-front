export const zeroSample = [
  {
    section: "Прихильниця юнацтва Пласту",
    items: [
      "Закінчила 11 років життя, подала заяву прихильниці юнацтва Пласту.",
      "Розмовляє українською мовою.",
      "Має повний пластовий однострій згідно 'Правильника однострою'.",
      ...
      "Знає, хто є Опікуном Пласту та хто є патронесою свого куреня. Знає як називається гурток.",
      "Знає всіх членкинь свого гуртка, свою впорядницю, курінну та зв'язкову. Має їхні контакти.",
      "Сплатила членську вкладку.",
    ],
  },
];
