export const zeroSample = [
  {
    section: "Прихильник Пласту",
    items: [
      "Закінчив 11 років життя, подав заяву прихильника юнацтва Пласту.",
      "Розмовляє українською мовою.",
      "Має повний пластовий однострій згідно з 'Правильником однострою'.",
      "Знає до якої парафії належить та бере участь у Літургії.",
      "Пояснить, що таке Пласт та хто такі пластуни. Знає Три Головні Обов'язки Пластуна.",
      "Вміє по-пластовому привітатися. Знає, як виглядає пластова відзнака і що вона символізує.",
      "Візьме участь у щонайменше 6 сходинах свого пластового гуртка.",
      "Візьме участь у мандрівці з гуртком чи куренем.",
      "Знає, хто є Опікуном Пласту та хто є патроном свого куреня. Знає, як називається гурток.",
      "Знає всіх членів свого гуртка, свою впорядника, курінного та зв'язкового. Має їхні контакти.",
      "Сплатив членську вкладку.",
    ],
  },
];
...
export const firstSample = [
  {
    section: "А Три головні обов’язки пластуна",
    items: [
  ...
  {
    section: "В Пластова організація",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      "Знає правила користування соціальними мережами, Інтернетом, правила онлайн-безпеки. Дотримується їх у житті.",
    ],
  },
  {
    section: "Е Тіловиховання",
    items: [
      "Знає основні вправи щоденної руханки та практикує її щоденно. Регулярно, принаймні двічі на тиждень, відвідує спортивну секцію або займається рухливими іграми/спортом.",
      "Вміє плавати та пропливе будь-яким стилем 50 метрів.",
      "Здобуде ВФВ свого віку (за бажанням).",
      "Візьме участь у спортивному змаганні чи іншому заході, яке триває не менше 3 годин.",
    ],
  },
  {
    section: "Є Юнацькі вмілості",
    items: [
      ...
      "Здобуде 5 пластових вмілостей Першої Проби (серед яких рекомендовано «Домашню зарадність 1»).",
      "Візьме участь у зайнятті на тему виготовлення і підготовки правильного виряду для прогулянки.",
      "Здобуде вмілість з відзначеного переліку пластових вмілостей.",
      "Здасть залік по одній з вмілиостей згідно з визначеним стандартом.",
      "Візьме участь в гурткових, курінних або окружних заходах (гутірка, майстерка, гра, конкурс).",
    ],
  },
];

export const secondSample = [
  {
    section: "А Три головні обов’язки пластунки",
    items: [
  ...
  {
    section: "Б Пластова ідея та організація",
    items: [
      ...
      "Знає, з яких частин складається Крайова Органіазція і світовий Пласт, назве головних членів Станичної, Крайової, Головної старшини. Вміє розрізняти їх відзнаки.",
  ...
  {
    section: "Г Життя в природі",
    items: [
      "Візьме участь у змаганні з денячого бігу (спортивному орієнтуванні).",
  ...
  },
  {
    ...
    items: [
      ...
      "Володіє іноземною мовою на доступному рівні (щонайменше В1 за глобальною шкалою), і для цього виконає наступні вимоги (одну на вибір):",
      "Представить власний життєпис на гурткових сходинах;",
      "Організує гутірку (дискусію) на обрану тему;",
      "Візьме участь у тренінгу (школі) іноземною мовою;",
      "Розповість про прочитану книгу іноземною мовою.",
    ],
  },
  {
    section: "Д Тіловиховання",
    items: [
